                    ...
                    <div class="modal-dialog modal-md">
                        <div class="modal-content modal-filled bg-light-primary">
                            <div class="modal-body p-4">
                                <form action="{{ route('income_expenses.approve_all') }}" method="post">
                                    @csrf
                                    @method('PUT')
    ...
    <script>
        $(function() {
         ...
         <script>
            $(document).on('click', '.approvalModel', function() {
                ...
                var route = "{{ route('income_expenses.approve', ['id' => ':id']) }}";
        ...
        <script>
            $(document).on('click', '.rejectModel', function() {
                var id = $(this).find('span').data('id');
                var route = "{{ route('income_expenses.reject', ['id' => ':id']) }}";
                route = route.replace(':id', id);
